...
function AllStudentNews() {
    ...
    const getAllPosts = async () => {
        const requestUrl = cate === "all" ? `http://27.71.228.19:5004/api/news?unit=Home&page=${offset}&size=${postsPerPage}` : `http://27.71.228.19:5004/api/news/getByCategoryName?&page=${offset}&size=${postsPerPage}&unit=Home&categoryName=${capitalize(cate)}`
